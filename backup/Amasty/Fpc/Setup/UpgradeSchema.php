...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    /**
     * @var Operation\CreateContextDebugTable
     */
    private $createContextDebugTable;
    ...
    public function __construct(
        ...
        Operation\CreateContextDebugTable $createContextDebugTable
    ) {
        ...
        $this->createContextDebugTable = $createContextDebugTable;
    }
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$context->getVersion() || version_compare($context->getVersion(), '2.3.1', '<')) {
            $this->createContextDebugTable->execute($setup);
        }
