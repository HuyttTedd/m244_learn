...
class ValidationProvider implements ValidationProviderInterface
{
        ...
        if ($fieldConfig) {
            ...
            foreach ($fieldConfig as $field) {
                ...
                foreach ($field->getValidations() as $validationConfig) {
                    ...
                    if ($validationConfig->getIsApplyToRootEntityOnly()
                        && !$profileEntitiesConfig->getIsRoot()
                    ) {
                        continue;
                    }
     ...
     */
    private function markRoots(
        EntitiesConfigInterface $config,
        ?EntitiesConfigInterface $parentConfig = null
    ) {
        $isRoot = false;
