...
class Filter implements \Amasty\ImportCore\Api\FormInterface
{
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'text' => __('Only those fields that are included into mapping '
    ...
    private function prepareEntitiesFilters(
        ...
        foreach ($fields as $field) {
            if ($field->getFilter()) {
                if ($field->getLabel()) {
                    $optionLabel = __($field->getLabel())
                        . '(' . $field->getMap() ?: $field->getName() . ')';
                } else {
                            ...
                            'arguments' => [
                                'data' => [
                                    'config' => [
                                        ...
                                        'additionalClasses' => 'amwidth40px data-grid-actions-cell'
                                            . ' amimportcore-remove',
