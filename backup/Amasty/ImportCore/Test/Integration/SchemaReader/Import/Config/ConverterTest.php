    ...
    public function convertDataProvider(): array
    {
        return [
            'basic' => [
                ...
                json_decode(
                    \file_get_contents(__DIR__ . '/../../../_files/converter_files/basic.json'),
                    true
                )
            ],
            'behavior' => [
                ...
                json_decode(
                    \file_get_contents(__DIR__ . '/../../../_files/converter_files/behaviors.json'),
                    true
                )
            ],
            'fields' => [
                ...
                json_decode(
                    \file_get_contents(__DIR__ . '/../../../_files/converter_files/fields.json'),
                    true
                )
            ],
            'sample_data' => [
                ...
                json_decode(
                    \file_get_contents(__DIR__ . '/../../../_files/converter_files/sample_data.json'),
                    true
                )
            ]
        ];
